...
public interface StudentSystem
{
    ...
    /**
     * Sets the location of a student with latitude and longitude.
     * 
     * @param studentId the id of the student to set location of.
     * @param latitude the latitude of the student.
     * @param longitude the longitude of the student.
     */
